    ...
    <div style={{ padding: "32px" }}>
      ...
      <header style={{ 
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          <div>
            <h1 style={{ fontSize: "24px", marginBottom: "4px" }}>Dashboard Amministrativa</h1>
          ...
          <tbody>
            {loading ? (
              ...
              patients.slice(0, 5).map((p, i) => (
                <tr key={p.id} style={{ borderBottom: i === Math.min(patients.length, 5) - 1 ? "none" : "1px solid var(--border)" }}>
